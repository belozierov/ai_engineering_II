...
// The pooling-strategy fix and UnresolvedPoolingError are preserved verbatim: they were
// verified vector-by-vector against sentence-transformers. This is the only MLX-linked target.
import Foundation
import MLX
import MLXEmbedders
