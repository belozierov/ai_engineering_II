#!/bin/sh
#
# Build (via xcodebuild) and run ticket-search with MLX's Metal library on the search path.
#
...
#
# Usage:
#   ./run.sh [args…]              # e.g. ./run.sh --clusters 6 --query "refund not received"
